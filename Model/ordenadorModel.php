...
class ordenadorModel extends ordenadorClass {
    ...
    //protected $objectOrdenadorFecha;  //ordenagailuFecha ko datuak gordeko dira hemen objetu bezala
  ...
  */
        ...
        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
            ...
            $new->objectOrdenadorFecha=$datosOrdenadorFecha->findIdOrdenadorFechaOrdenador($row['idOrdenador']);
 ...
 */
 public function findOrdenadorByIdOrdenador($idOrdenador)
 {/*
  * returns a list with all the books (objects) edited by a given editorial.
  */
        $this->OpenConnect();  // konexioa zabaldu  - abrir conexión
        $sql = "CALL spOrdenadoresPorFecha(".$idOrdenador.")"; // SQL sententzia - sentencia SQL
        $this->list = array(); // objetuaren list atributua array bezala deklaratzen da - 
                    //se declara como array el atributo list del objeto
